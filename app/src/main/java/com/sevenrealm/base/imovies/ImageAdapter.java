...
public class ImageAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (cursor.getInt(MainActivityFragment.COL_MOVIE_FAV) == 1){
        ...
        title.setText(Title);
        String url = new Core(context).large_image_url + cursor.getString(MainActivityFragment.COL_MOVIE_IMAGE);
